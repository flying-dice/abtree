# Test report — Default — unclassifiable time falls through to Default_Greeting

**Tree:** hello-world
**Spec:** .abtree/trees/hello-world/TEST__default.yaml
**Target execution:** test-tree-run-default-unclassifiable-tim__hello-world__1
**Overall:** PASS
...
|---|---|---|---|
| status | done | done | ✓ |
| local.time_of_day | null | null | ✓ |
| local.greeting | non-empty neutral greeting addressing $GLOBAL.user_name | "Hello, John Doe." | ✓ |

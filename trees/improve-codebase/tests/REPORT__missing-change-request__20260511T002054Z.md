# Test report — No change_request seeded → Check_Intent guard fails and the workflow aborts on its first step

**Tree:** improve-codebase (v1.1.0)
**Runner:** test-tree (v1.2.0, fixture-driven side effects)
**Spec:** .abtree/trees/improve-codebase/TEST__missing-change-request.yaml
**Target execution:** test-missing-change-request-no-scope-see__improve-codebase__1
**Overall:** PASS
...
| local.scope_confirmed | null | null | ✓ |
...
```mermaid
---
title: "test-missing-change-request no scope seeded (failed)"
---
flowchart TD
    Improve_Codebase{{"Improve Codebase\n[sequence]"}}
    0_Check_Intent["Check Intent\n[action]"]
    Improve_Codebase --> 0_Check_Intent
    style 0_Check_Intent fill:#f87171,stroke:#dc2626,color:#450a0a
